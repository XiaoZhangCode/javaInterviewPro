...
VALUES (1, 'user1', 'b0dd3697a192885d7c055db46155b26a', 'unionId1', 'mpOpenId1', 'user1',
       ...
       (5, 'xiaozhang', 'b0dd3697a192885d7c055db46155b26a', NULL, NULL, '小张', 'https://www.code-nav.cn/logo.png',
        '系统管理员', 'admin');

-- 题库表初始数据
INSERT INTO question_bank (title, description, picture, creator)
...
-- 题目表初始数据
INSERT INTO question (title, content, tags, answer, creator)
