...
public class Generator {
    ...
    static String url = "jdbc:mysql://localhost:3306/java_inter_view_pro?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=Asia/Shanghai";
